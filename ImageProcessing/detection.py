...
def imageToTensor(img):
    ...
    '''
    print("ImageProcessing.detection.imageToTensor: This function require tensorflow that slow importing time Please implement this func in your main script")
...
def getBoxesScoreClass(detectionObj, scoreTH):
    '''
        detectionObj: output from detection model(saved_model)
